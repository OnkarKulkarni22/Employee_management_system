...
<head>
	...
	<style>
		...
		table{
			...
			margin: 20px auto;
			color: black; /* Set table font color to black */
			border: 1px solid black; /* Set default table border color to black */
		}
		th, td{
			border: 1px solid black; /* Set cell border color to black */
			padding: 8px;
			text-align: center;
		}
		th{
...
<body>
	<h2 style="text-align: center; color: black;">Employee List</h2>
	<table>
		<thead>
			<tr>
				<th>Employee Name</th>
		...
		<tbody>
				<c:forEach var="data" items="${employee}">
				<tr>
					<td>${data.name}</td>
					<td>${data.email}</td>
					<td>${data.salary}</td>
