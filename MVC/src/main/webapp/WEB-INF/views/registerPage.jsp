...
<form action="result" method="POST" id="registrationForm">
...
<small id="password-strength" class="form-text text-muted">Password strength: <span id="strength-text"></span></small>
